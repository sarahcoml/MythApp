...
function ClothCard({ item, addToCart }) { // Add addToCart as a prop
    ...
    return (
      <Card className="cloth-card" style={{ width: '18rem', border: 'none', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }}>
        ...
        <Card.Body>
          ...
          <div className="mt-3">
            <Button className="mr-2" variant="info" onClick={() => addToCart(item)}>Add to Cart</Button> {/* Use addToCart in the onClick handler */}
